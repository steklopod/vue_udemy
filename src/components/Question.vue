      ...
      generateQuestion () {
        ...
        switch (modeNumber) {
          case MODE_ADDITION:
            ...
            this.question = `Чему равна сума ${firstNumber} + ${secondNumber}?`
            break
          case MODE_SUBTRACTION:
            correctAnswer = firstNumber - secondNumber
            this.question = `Чему равна разница ${firstNumber} - ${secondNumber}?`
            break
          default:
            correctAnswer = 0
            this.question = 'Упс, произошла ошибка :/'
        }
